...
canvas_width = 800
canvas_height = 800
canvas = tk.Canvas(root, width=canvas_width, height=canvas_height, bg="white", highlightbackground="black", highlightthickness=2)
canvas.pack()
...
for _ in range(num_dots):
    ...
    dot = canvas.create_oval(x - dot_radius, y - dot_radius, x + dot_radius, y + dot_radius, fill="red")
    dots.append(dot)
...
def move_dots():
    for i in range(num_dots):
        ...
        canvas.coords(dots[i], x - dot_radius, y - dot_radius, x + dot_radius, y + dot_radius)
